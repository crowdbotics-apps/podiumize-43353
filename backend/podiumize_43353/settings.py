"""
Django settings for podiumize_43353 project.
...
ROOT_URLCONF = 'podiumize_43353.urls'
...
WSGI_APPLICATION = 'podiumize_43353.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "podiumize_43353 API",
    "DESCRIPTION": "API documentation for podiumize_43353 App",
    "VERSION": "v1",
}
